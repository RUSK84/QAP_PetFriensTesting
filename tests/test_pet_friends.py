...
def test_add_new_pet_with_valid_data_without_photo(name='Барон', animal_type='терьер',
                                     age='2'):
...
def test_add_new_photo(pet_photo='images/cat2.jpg'):
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet_without_photo(auth_key, "Сара", "пес", "4")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_add_new_pet_with_invalid_age(name='Слава', animal_type='кот',
                                          age='аолвавлалврвлр'):
...
def test_delete_self_pet_with_invalid_authkey():
    """Проверяем возможность удаления питомца c несуществующим auth_key"""
    ...
    # Проверяем - если список своих питомцев пустой, то добавляем нового и опять запрашиваем список своих питомцев
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "Сара", "кот", "4", "images/cat1.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_delete_self_pet_with_invalid_pet_id():
    ...
    # Проверяем - если список своих питомцев пустой, то добавляем нового и опять запрашиваем список своих питомцев
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "Борис", "кот", "4", "images/cat1.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_update_self_pet_info_with_invalid_pet_id(name='Том', animal_type='пес', age=5):
...
def test_update_self_pet_info_with_invalid_authkey(name='Мурз', animal_type='дворовой кот', age=5):
